...
namespace OgreFramework
{
	...
	/*void EntityAdapter::onMovement(int x, int y)
	{
		::std::cout<<"Je suis EntityAdapter::onMovement()"<<::std::endl ;
		PickableObject::onMovement(x,y) ;		
 		setPosition(Math::Vector3<Config::Real>(x,y,0)) ;
	}*/
